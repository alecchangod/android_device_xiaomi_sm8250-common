...
PRODUCT_ADB_KEYS := $(LOCAL_PATH)/adb-keys/adb_key.pub
...
PRODUCT_COPY_FILES += \
    ...
    frameworks/native/data/etc/android.hardware.vr.high_performance.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/com.android.vr.high_performance.xml
